...
import dev.junker.figby.util.EQUAL_SIGN
import dev.junker.figby.util.HYPHEN
import dev.junker.figby.util.UNDERSCORE
import dev.junker.figby.util.VERTICAL_BAR

/**
 * Defines how to horizontally smush [FigChar][dev.junker.figby.font.FigChar] sub-characters.
 */
...
/**
 * Defines how to vertically smush [FigChar][dev.junker.figby.font.FigChar] sub-characters.
 */
